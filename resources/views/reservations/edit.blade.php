                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('reservation.update', $reservation->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $reservation->ReservedName) }}"  autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phoneNumber" type="text" class="form-control @error('phoneNumber') is-invalid @enderror" name="phoneNumber" value="{{ old('phoneNumber', $reservation->PhoneNumber) }}" autocomplete="phoneNumber">
                        ...
                        <label for="ticketId" maxlength="1500" class="col-md-4 col-form-label text-md-end">Typ biletu</label>
                            ...
                            <select name="ticketId" id="ticketId" class="form-select">
                                @foreach ($tickets as $ticketType)
                                    <option value="{{ $ticketType->id }}"
                                        data-price="{{ $ticketType->price }}"
                                        {{ $ticketType->id == old('ticketId', $reservation->TicketType) ? 'selected' : '' }}>
                                        {{ $ticketType->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="reservationDate" type="date" class="form-control @error('resevationDate') is-invalid @enderror" name="reservationDate" value="{{ old('reservationDate', $reservation->ReservationDate) }}" autocomplete="reservationDate" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="count" type="number" class="form-control @error('count') is-invalid @enderror" name="count" value="{{ old('count', $reservation->Count) }}" onchange="calculateTotalAmount()">
                    ...
                    <form action="{{ route('reservation.destroy', $reservation->id) }}" method="POST" onsubmit="return confirm('Na pewno usunąć tę rezerwację?');" style="margin-top: 1rem;">
                            @csrf
                            @method('DELETE')
